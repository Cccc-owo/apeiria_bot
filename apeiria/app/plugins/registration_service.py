...
if TYPE_CHECKING:
    from apeiria.infra.config.adapters import AdapterConfig
    from apeiria.infra.config.drivers import DriverConfig
    from apeiria.infra.config.plugins import PluginConfig

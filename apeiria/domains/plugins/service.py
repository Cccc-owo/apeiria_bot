...
class PluginCatalogService:
    ...
    async def uninstall_plugin(
        ...
        *,
        ...
        if remove_config:
            section = get_plugin_declared_configs(module_name).section
    ...
    async def list_orphan_plugin_configs(self) -> list[OrphanPluginConfigItem]:
        ...
        for section in section_names:
            ...
            if mapped_module and (
                ...
                or self._is_module_importable(mapped_module)
            ):
                continue
            orphaned.append(
    ...
    def _is_module_importable(self, module_name: str | None) -> bool:
        if not module_name:
            return False
        try:
